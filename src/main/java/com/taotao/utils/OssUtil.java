...
public class OssUtil {
	...
	public static void main(String[] args) throws IOException {
		...
		download(ossClient, "qwe-nie", "three.jpg", "C:\\Users\\pc\\Desktop\\11.jpg");
		ossClient.shutdown();
	 ...
	 */
	public static void upload(OSSClient ossClient,String bucketName,String fileKey,InputStream fileStream) {
		ossClient.putObject(bucketName, fileKey, fileStream);
	 ...
	 * @throws IOException
	 */
	public static void download(OSSClient ossClient,String bucketName,String fileKey,String filePath) throws IOException {
		//流式下载
...
//		reader.close();
		//下载到本地：
		ossClient.getObject(new GetObjectRequest(bucketName, fileKey), new File(filePath));
